...
import { ProjectCoordinationHeroSection } from "@/lib/db";
...
interface Props {
  section: ProjectCoordinationHeroSection;
  isEditing: boolean;
  onUpdate: (updates: Partial<ProjectCoordinationHeroSection>) => void;
}

export default function EditableProjectCoordinationHeroSection({
  section,
  isEditing,
  onUpdate,
}: Props) {
  ...
  const {
    ...
    secondaryButtonLink = "#approval-standards",
          ...
          >
            {primaryButtonText && (
              <a
                ...
                className="px-10 py-5 bg-red-600 text-white rounded-full font-semibold hover:bg-red-700 hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
                {primaryButtonText}
              </a>
            )}
  ...
  // ───── EDITOR MODE – Pure White & Light Theme ─────
  const PreviewCard = () => (
    <motion.div
      layout
    ...
    >
      ...
      {showFloatingElements && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          />
          <motion.div
            className="absolute bottom-32 -right-32 w-96 h-96 rounded-full blur-3xl bg-blue-600/10"
            animate={{ y: [0, 40, -30, 0] }}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Left: Preview (still shows the actual hero with dark bg – correct!) */}
          <motion.div
          ...
          {/* Right: Controls – Pure White & Clean */}
            ...
            >
              ...
              <div className="space-y-7">
                ...
                <EditableColorPicker
                  ...
                  onChange={(v) =>
                    handleUpdate({ backgroundColor: v })
                  }
                />
                ...
                <EditableCheckbox
                  ...
                  onChange={(v) =>
                    handleUpdate({ showFloatingElements: v })
                  }
                />
              </div>
            </motion.div>
