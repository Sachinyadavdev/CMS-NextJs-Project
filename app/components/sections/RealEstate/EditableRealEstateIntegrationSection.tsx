          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2
                ...
                style={{ color: titleColor, animation: 'fadeInUp 1s ease-out 0.1s both' }}
              >
                {title}
              </h2>
              ...
              {description && (
                <p
                  ...
                  style={{ color: textColor, animation: 'fadeInUp 1s ease-out 0.3s both' }}
                >
                  {description}
                </p>
              )}
            ...
            {/* Right: Image */}
            <div
              className="relative overflow-hidden rounded-2xl shadow-2xl h-96 lg:h-full min-h-96 image-glass-hover"
