...
interface StrategicAdvantagesHeroContent {
  title?: string;
  subtitle?: string;
  description?: string;
...
type StrategicAdvantagesSectionType = BaseSection<StrategicAdvantagesHeroContent>;

interface Props {
  section: StrategicAdvantagesSectionType;
  isEditing: boolean;
  onUpdate: (updates: Partial<StrategicAdvantagesSectionType>) => void;
}

export default function EditableStrategicAdvantagesHeroSection({
  section,
  isEditing,
  onUpdate,
}: Props) {
    ...
    >
      ...
      {showFloatingElements && (
        <div className="absolute inset-0 pointer-events-none">
          ...
          />
          <motion.div
            className="absolute bottom-32 -right-32 w-96 h-96 rounded-full blur-3xl bg-indigo-600/10"
            animate={{ y: [0, 40, -30, 0] }}
      ...
      >
        <div className="max-w-7xl mx-auto px-8 py-6">
          <h1 className="text-3xl font-bold text-gray-900">
            Strategic Advantages Hero Section Editor
          </h1>
