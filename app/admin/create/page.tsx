...
export default function CreateLayoutPage() {
  ...
  const confirmSubmit = async () => {
    ...
    try {
      ...
      setToast({
        message: err instanceof Error ? err.message : "Error creating layout",
        type: "error",
      });
    } finally {
      setSaving(false);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Design your page structure and content
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-primary-50 to-primary-25">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Define the basic structure and metadata for your layout
                </p>
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Review your layout details before creating. You'll be able to
                add sections and content after creation.
              </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full mx-auto shadow-xl">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to create this layout? You can add sections
              and content after creation.
            </p>
